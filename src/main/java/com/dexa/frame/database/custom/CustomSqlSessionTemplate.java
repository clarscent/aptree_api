...
public class CustomSqlSessionTemplate extends SqlSessionTemplate {
	...
	public CustomSqlSessionTemplate(SqlSessionFactory sqlSessionFactory, ExecutorType executorType, PersistenceExceptionTranslator exceptionTranslator) throws IllegalAccessException {
		...
		field.set(this, (SqlSession) newProxyInstance(SqlSessionFactory.class.getClassLoader(), new Class[]{SqlSession.class}, new CustomSqlSessionInterceptor()));
	...
	private class CustomSqlSessionInterceptor implements InvocationHandler {
		...
		public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
			...
			try {
				...
				System.out.println("31#" + (result instanceof List));
				System.out.println("32#" + (result instanceof Map));
				System.out.println("33#" + (result instanceof String));
				System.out.println("34#" + (result instanceof Integer));
				 */
				...
				sqlQuery = getQuery(sqlSession, (String) args[0], null);
